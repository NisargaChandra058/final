...
try {
    ...
    // --- THIS IS THE FIX ---
    // Added "IF NOT EXISTS" to the constraint creation
    $pdo->exec("ALTER TABLE students ADD CONSTRAINT IF NOT EXISTS students_email_unique UNIQUE (email);");
    $pdo->exec("ALTER TABLE students ADD CONSTRAINT IF NOT EXISTS students_usn_unique UNIQUE (usn);");
    // --- END OF FIX ---
